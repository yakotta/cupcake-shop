...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/resources/bootstrap-datepicker-1.6.4-dist/css/bootstrap-datepicker.min.css" />
    ...
    <body>
        ...
        <script src="/resources/javascript/numberspinner.js" type="text/javascript"></script>
        <script src="/resources/javascript/submit.js" type="text/javascript"></script>
        <script src="/resources/javascript/total.js" type="text/javascript"></script>
